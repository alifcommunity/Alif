...
//    STRUCT_FOR_ASCII_STR(LITERAL) _ALIF_ ## NAME;
//#define STRUCT_FOR_ID(NAME) \
//    STRUCT_FOR_ASCII_STR(#NAME) _ALIF_ ## NAME;
//
//// XXX Order by frequency of use?
//
///* The following is auto-generated by Tools/build/generate_global_objects.alif. */
//    class AlifSubGlobalStrings {
//        class {
//            STRUCT_FOR_STR(anon_dictcomp, L"<dictcomp>")
...
//                //STRUCT_FOR_STR(anon_null, "<nullptr>")
...
//
//
//#define ALIFSUB_ID(NAME) \
//     (ALIFSUB_SINGLETON(strings.identifiers._ALIF_ ## NAME._ascii.ob_base))
//#define ALIFSUB_STR(NAME) \
//     (ALIFSUB_SINGLETON(strings.literals._ALIF_ ## NAME._ascii.ob_base))
//
//#define ALIFSUB_DECLARE_STR(name, str)
