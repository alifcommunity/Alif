...
ALIF_LOCAL_INLINE(void)
STRINGLIB(replace1CharInplace)(STRINGLIB_CHAR* s, STRINGLIB_CHAR* end,
	AlifUCS4 u1, AlifUCS4 u2, AlifSizeT maxcount)
{
	*s = u2;
	while (--maxcount and ++s != end) {
